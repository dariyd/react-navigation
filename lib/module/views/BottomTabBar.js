...
class TabBarBottom extends React.Component {
  ...
  componentDidMount() {
    if (Platform.OS === 'ios') {
      this.navSubs.concat([Keyboard.addListener('keyboardWillShow', this._handleKeyboardShow), Keyboard.addListener('keyboardWillHide', this._handleKeyboardHide)]);
    } else {
      this.navSubs.concat([Keyboard.addListener('keyboardDidShow', this._handleKeyboardShow), Keyboard.addListener('keyboardDidHide', this._handleKeyboardHide)]);
    }
  }
