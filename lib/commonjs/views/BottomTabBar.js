...
class TabBarBottom extends React.Component {
  ...
  componentDidMount() {
    if (_reactNative.Platform.OS === 'ios') {
      this.navSubs.concat([_reactNative.Keyboard.addListener('keyboardWillShow', this._handleKeyboardShow), _reactNative.Keyboard.addListener('keyboardWillHide', this._handleKeyboardHide)]);
    } else {
      this.navSubs.concat([_reactNative.Keyboard.addListener('keyboardDidShow', this._handleKeyboardShow), _reactNative.Keyboard.addListener('keyboardDidHide', this._handleKeyboardHide)]);
    }
  }

  componentWillUnmount() {
    this.navSubs.forEach(sub => sub.remove());
  } // @ts-ignore
